...
class PetGeoCommunityProfileForMods extends StatefulWidget {
  const PetGeoCommunityProfileForMods({Key? key}) : super(key: key);

  @override
  State<PetGeoCommunityProfileForMods> createState() => _PetGeoCommunityProfileForModsState();
}

class _PetGeoCommunityProfileForModsState extends State<PetGeoCommunityProfileForMods> with SingleTickerProviderStateMixin {
                            ...
                            Container(
                              ...
                              child: Center(
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(100),
                                  child: Image.asset(
                                    'assets/images/Depositphotos_14094278_ds (1) 1.png',
                                    height: Get.height,
                                  ),
                                ),
                              ),
